...
static const char* ChannelService_method_names[] = {
  ...
  "/srv.ChannelService/GetPrivateChannel",
...
ChannelService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetPrivateChannel_(ChannelService_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListUserChannels_(ChannelService_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CheckIsMemberChannel_(ChannelService_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CheckIsMemberAndGetChannel_(ChannelService_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AddMembersChannel_(ChannelService_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RemoveMemberChannel_(ChannelService_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ChannelService::Stub::GetPrivateChannel(::grpc::ClientContext* context, const ::srv::GetPrivateChannelRequest& request, ::msg::Channel* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetPrivateChannel_, context, request, response);
}

void ChannelService::Stub::experimental_async::GetPrivateChannel(::grpc::ClientContext* context, const ::srv::GetPrivateChannelRequest* request, ::msg::Channel* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetPrivateChannel_, context, request, response, std::move(f));
}

void ChannelService::Stub::experimental_async::GetPrivateChannel(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::msg::Channel* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetPrivateChannel_, context, request, response, std::move(f));
}

void ChannelService::Stub::experimental_async::GetPrivateChannel(::grpc::ClientContext* context, const ::srv::GetPrivateChannelRequest* request, ::msg::Channel* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetPrivateChannel_, context, request, response, reactor);
}

void ChannelService::Stub::experimental_async::GetPrivateChannel(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::msg::Channel* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetPrivateChannel_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::msg::Channel>* ChannelService::Stub::AsyncGetPrivateChannelRaw(::grpc::ClientContext* context, const ::srv::GetPrivateChannelRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::msg::Channel>::Create(channel_.get(), cq, rpcmethod_GetPrivateChannel_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::msg::Channel>* ChannelService::Stub::PrepareAsyncGetPrivateChannelRaw(::grpc::ClientContext* context, const ::srv::GetPrivateChannelRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::msg::Channel>::Create(channel_.get(), cq, rpcmethod_GetPrivateChannel_, context, request, false);
}
...
ChannelService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChannelService::Service, ::srv::GetPrivateChannelRequest, ::msg::Channel>(
          [](ChannelService::Service* service,
             ::grpc_impl::ServerContext* ctx,
             const ::srv::GetPrivateChannelRequest* req,
             ::msg::Channel* resp) {
               return service->GetPrivateChannel(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status ChannelService::Service::GetPrivateChannel(::grpc::ServerContext* context, const ::srv::GetPrivateChannelRequest* request, ::msg::Channel* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
