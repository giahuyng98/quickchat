...
extern GetPrivateChannelRequestDefaultTypeInternal _GetPrivateChannelRequest_default_instance_;
...
template<> ::srv::GetPrivateChannelRequest* Arena::CreateMaybeMessage<::srv::GetPrivateChannelRequest>(Arena*);
...
class GetPrivateChannelRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:srv.GetPrivateChannelRequest) */ {
 public:
  inline GetPrivateChannelRequest() : GetPrivateChannelRequest(nullptr) {};
  virtual ~GetPrivateChannelRequest();

  GetPrivateChannelRequest(const GetPrivateChannelRequest& from);
  GetPrivateChannelRequest(GetPrivateChannelRequest&& from) noexcept
    : GetPrivateChannelRequest() {
    *this = ::std::move(from);
  }

  inline GetPrivateChannelRequest& operator=(const GetPrivateChannelRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetPrivateChannelRequest& operator=(GetPrivateChannelRequest&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetPrivateChannelRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetPrivateChannelRequest* internal_default_instance() {
    return reinterpret_cast<const GetPrivateChannelRequest*>(
               &_GetPrivateChannelRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(GetPrivateChannelRequest& a, GetPrivateChannelRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetPrivateChannelRequest* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetPrivateChannelRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetPrivateChannelRequest* New() const final {
    return CreateMaybeMessage<GetPrivateChannelRequest>(nullptr);
  }

  GetPrivateChannelRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetPrivateChannelRequest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetPrivateChannelRequest& from);
  void MergeFrom(const GetPrivateChannelRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetPrivateChannelRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "srv.GetPrivateChannelRequest";
  }
  protected:
  explicit GetPrivateChannelRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // uint64 uid1 = 1;
  void clear_uid1();
  ::PROTOBUF_NAMESPACE_ID::uint64 uid1() const;
  void set_uid1(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_uid1() const;
  void _internal_set_uid1(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:

  // uint64 uid2 = 2;
  void clear_uid2();
  ::PROTOBUF_NAMESPACE_ID::uint64 uid2() const;
  void set_uid2(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_uid2() const;
  void _internal_set_uid2(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:

  // @@protoc_insertion_point(class_scope:srv.GetPrivateChannelRequest)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::uint64 uid1_;
  ::PROTOBUF_NAMESPACE_ID::uint64 uid2_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_channel_5fservice_2eproto;
};
// ===================================================================
...
// uint64 uid1 = 1;
inline void GetPrivateChannelRequest::clear_uid1() {
  uid1_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetPrivateChannelRequest::_internal_uid1() const {
  return uid1_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetPrivateChannelRequest::uid1() const {
  // @@protoc_insertion_point(field_get:srv.GetPrivateChannelRequest.uid1)
  return _internal_uid1();
}
inline void GetPrivateChannelRequest::_internal_set_uid1(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  uid1_ = value;
}
inline void GetPrivateChannelRequest::set_uid1(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_uid1(value);
  // @@protoc_insertion_point(field_set:srv.GetPrivateChannelRequest.uid1)
}

// uint64 uid2 = 2;
inline void GetPrivateChannelRequest::clear_uid2() {
  uid2_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetPrivateChannelRequest::_internal_uid2() const {
  return uid2_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetPrivateChannelRequest::uid2() const {
  // @@protoc_insertion_point(field_get:srv.GetPrivateChannelRequest.uid2)
  return _internal_uid2();
}
inline void GetPrivateChannelRequest::_internal_set_uid2(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  uid2_ = value;
}
inline void GetPrivateChannelRequest::set_uid2(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_uid2(value);
  // @@protoc_insertion_point(field_set:srv.GetPrivateChannelRequest.uid2)
}
