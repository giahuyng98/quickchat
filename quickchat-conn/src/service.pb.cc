...
static void InitDefaultsscc_info_What_service_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::_What_default_instance_;
    new (ptr) ::What();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::What::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_What_service_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_What_service_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_service_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::What, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::What, msg_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::_What_default_instance_),
};

const char descriptor_table_protodef_service_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rservice.proto\"\023\n\004What\022\013\n\003msg\030\001 \001(\t2&\n\013"
  "UserService\022\027\n\005hello\022\005.What\032\005.What\"\000b\006pr"
  "oto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_service_2eproto_sccs[1] = {
  &scc_info_What_service_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_service_2eproto = {
  false, false, descriptor_table_protodef_service_2eproto, "service.proto", 84,
...
What::What(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:What)
}
What::What(const What& from)
  ...
  // @@protoc_insertion_point(copy_constructor:What)
}

void What::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_What_service_2eproto.base);
  msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

What::~What() {
  // @@protoc_insertion_point(destructor:What)
  SharedDtor();
...
void What::Clear() {
// @@protoc_insertion_point(message_clear_start:What)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "What.msg"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* What::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:What)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:What)
  return target;
}

size_t What::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:What)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:What)
  GOOGLE_DCHECK_NE(&from, this);
  const What* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<What>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:What)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:What)
    MergeFrom(*source);
  }
}

void What::MergeFrom(const What& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:What)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:What)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:What)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::What* Arena::CreateMaybeMessage< ::What >(Arena* arena) {
  return Arena::CreateMessageInternal< ::What >(arena);
}
