...
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "mestamp.proto\032\022chat_content.proto\"\340\002\n\007Me"
  "ssage\022\022\n\nchannel_id\030\001 \001(\004\022\022\n\nmessage_id\030"
  "\002 \001(\004\022\017\n\007user_id\030\003 \001(\004\022\035\n\007content\030\004 \001(\0132"
  "\014.ChatContent\022 \n\005seens\030\005 \003(\0132\021.msg.Messa"
  "ge.Seen\022(\n\treactions\030\006 \003(\0132\025.msg.Message"
  ".Reaction\022-\n\tcreate_at\030\007 \001(\0132\032.google.pr"
  "otobuf.Timestamp\032<\n\010Reaction\022\017\n\007user_id\030"
  "\001 \001(\004\022\037\n\004type\030\002 \001(\0162\021.msg.ReactionType\032D"
  "\n\004Seen\022\017\n\007user_id\030\001 \001(\004\022+\n\007seen_at\030\002 \001(\013"
  "2\032.google.protobuf.Timestamp*h\n\014Reaction"
  "Type\022\013\n\007UNKNOWN\020\000\022\010\n\004LOVE\020\001\022\010\n\004HAHA\020\002\022\014\n"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2eproto = {
  false, false, descriptor_table_protodef_message_2eproto, "message.proto", 542,
...
void Message::InitAsDefaultInstance() {
  ::msg::_Message_default_instance_._instance.get_mutable()->content_ = const_cast< ::ChatContent*>(
      ::ChatContent::internal_default_instance());
  ::msg::_Message_default_instance_._instance.get_mutable()->create_at_ = const_cast< PROTOBUF_NAMESPACE_ID::Timestamp*>(
      PROTOBUF_NAMESPACE_ID::Timestamp::internal_default_instance());
}
class Message::_Internal {
 public:
  static const ::ChatContent& content(const Message* msg);
...
Message::Message(const Message& from)
  ...
  if (from._internal_has_content()) {
    content_ = new ::ChatContent(*from.content_);
  } else {
    content_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:msg.Message)
  ...
  if (from.has_content()) {
    _internal_mutable_content()->::ChatContent::MergeFrom(from._internal_content());
  }
