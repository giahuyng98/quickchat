...
MessageService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_GetMessage_(MessageService_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetMessages_(MessageService_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetLastMessage_(MessageService_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status MessageService::Stub::GetMessage(::grpc::ClientContext* context, const ::srv::GetMessageRequest& request, ::srv::GetMessageReponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetMessage_, context, request, response);
}

void MessageService::Stub::experimental_async::GetMessage(::grpc::ClientContext* context, const ::srv::GetMessageRequest* request, ::srv::GetMessageReponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetMessage_, context, request, response, std::move(f));
}

void MessageService::Stub::experimental_async::GetMessage(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::srv::GetMessageReponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetMessage_, context, request, response, std::move(f));
}

void MessageService::Stub::experimental_async::GetMessage(::grpc::ClientContext* context, const ::srv::GetMessageRequest* request, ::srv::GetMessageReponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetMessage_, context, request, response, reactor);
}

void MessageService::Stub::experimental_async::GetMessage(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::srv::GetMessageReponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetMessage_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::srv::GetMessageReponse>* MessageService::Stub::AsyncGetMessageRaw(::grpc::ClientContext* context, const ::srv::GetMessageRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::srv::GetMessageReponse>::Create(channel_.get(), cq, rpcmethod_GetMessage_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::srv::GetMessageReponse>* MessageService::Stub::PrepareAsyncGetMessageRaw(::grpc::ClientContext* context, const ::srv::GetMessageRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::srv::GetMessageReponse>::Create(channel_.get(), cq, rpcmethod_GetMessage_, context, request, false);
}
...
MessageService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< MessageService::Service, ::srv::GetMessageRequest, ::srv::GetMessageReponse>(
          [](MessageService::Service* service,
             ::grpc_impl::ServerContext* ctx,
             const ::srv::GetMessageRequest* req,
             ::srv::GetMessageReponse* resp) {
...
::grpc::Status MessageService::Service::GetMessage(::grpc::ServerContext* context, const ::srv::GetMessageRequest* request, ::srv::GetMessageReponse* response) {
  (void) context;
  (void) request;
  (void) response;
