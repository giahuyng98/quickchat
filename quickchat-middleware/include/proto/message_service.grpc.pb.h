...
class MessageService final {
 public:
  ...
  typedef WithAsyncMethod_GetMessages<WithAsyncMethod_GetLastMessage<Service > > AsyncService;
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_GetMessages<ExperimentalWithCallbackMethod_GetLastMessage<Service > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_GetMessages<ExperimentalWithCallbackMethod_GetLastMessage<Service > > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_GetMessages<WithStreamedUnaryMethod_GetLastMessage<Service > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetMessages<WithStreamedUnaryMethod_GetLastMessage<Service > > StreamedService;
};
